...
class PropositionsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Propositions'];
			if($model->save())
	...
	{
		$model=Propositions::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Propositions $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='propositions-form')
		{
